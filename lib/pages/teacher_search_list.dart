                              ...
                              child: ClipOval(
                                child: new SizedBox(
                                  ...
                                  child:(items.length==0)?(faculties[index].url == '' || faculties[index].url == null ) ? Image.asset('images/role_teacher.jpg',
                                      fit: BoxFit.cover) : Image.network(faculties[index].url,
                                      fit: BoxFit.cover) :( (items[index].url == '' || items[index].url == null ) ? Image.asset('images/role_teacher.jpg',
                                    fit: BoxFit.cover) : Image.network(items[index].url,
                                    fit: BoxFit.cover)),
                                ),
                              ),
                            ),
